因为喜欢看书，早前发现有一款Delphi写的小说快捕比较好用，先是研究了书源写法，写了教程
可惜很来软件没有开源又没人维护，不能处理https网站和分页网站的情况，基本就没有再用。自己有点编程基础就先简单做了1个通用小说下载器，根据目录页下载章节的小工具
很来。再后来就出现一款kotlin开发的安卓阅读的软件，比较好用，又是开源的，也在第1时间研究了书源写法，阅读功能强大，但是阅读的书源写法还是很复杂，如果想在电脑上只适合用虚拟机。虽然阅读有flutter版本开发，但是烂尾了，功能基本没实现。去年AI发展迅速就顺手用python把通用下载器的功能复刻，再借鉴快捕和阅读的优点，写了快捕Python版。
今年3月底的时候刚好想到flutter可以跨平台，然后就复现了快捕python版的功能，做了kuaibuflutter。整体功能倒是基本正常，但是有些地方做的不太好，于是开源出来，让更多人完善。
